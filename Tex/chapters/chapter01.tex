...
In the framework it lives in \path{runtime/run/RunId.java}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/runtime/run/RunId.java}}.
...
state.
In the framework it lives in \path{runtime/run/RunSnapshot.java}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/runtime/run/RunSnapshot.java}}.
...
In the framework the failure types live in \path{core/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/core/}}.
...
invocation.
In the framework it lives in \path{modelclient/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/modelclient/}}.
...
\path{orchestrator/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/orchestrator/}}.
...
records.
In the framework it lives in \path{memory/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/memory/}}.
\texttt{MemoryPolicy} governs which records are selected for the model's context window
and when records are retired.
Both live in \path{memory/}.
\texttt{ToolRegistry} resolves tools by name and exposes their descriptors to the
orchestrator.
In the framework it lives in
\path{tooling/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/tooling/}}.
...
In the framework it lives in
\path{security/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/security/}}.
\texttt{SecretResolver} resolves credentials without exposing raw secret material to
the runtime loop.
It also lives in \path{security/}.
\texttt{EventPublisher} emits structured events for every state transition.
In the framework it lives in
\path{observability/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/observability/}}.
...
\path{runtime/builder/}\footnote{\url{https://github.com/tnhmar/agent-framework/blob/main/src/main/java/com/agentruntime/runtime/builder/}}.
