...
\begin{tikzpicture}[
  ...
  domain/.style={layer, fill=teal!18},
  ...
  \node[domain] (domain) at (0, 2.4) {tooling + memory — ToolRegistry, MemoryStore};
...
Figure~\ref{fig:layer-architecture} shows how the six invariants map to the six
framework layers and the direction of allowed dependencies between them.
